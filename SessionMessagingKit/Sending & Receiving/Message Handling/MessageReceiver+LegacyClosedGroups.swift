...
extension MessageReceiver {
    public static func handleLegacyClosedGroupControlMessage(_ db: Database, _ message: LegacyClosedGroupControlMessage) throws {
        switch message.kind {
            case .new: try handleLegacyNewClosedGroup(db, message: message)
            case .encryptionKeyPair: try handleLegacyClosedGroupEncryptionKeyPair(db, message: message)
            case .nameChange: try handleLegacyClosedGroupNameChanged(db, message: message)
            case .membersAdded: try handleLegacyClosedGroupMembersAdded(db, message: message)
            case .membersRemoved: try handleLegacyClosedGroupMembersRemoved(db, message: message)
            case .memberLeft: try handleLegacyClosedGroupMemberLeft(db, message: message)
            case .encryptionKeyPairRequest: break
    ...
    private static func handleLegacyNewClosedGroup(_ db: Database, message: LegacyClosedGroupControlMessage) throws {
        ...
        try handleLegacyNewClosedGroup(
            db,
    ...
    internal static func handleLegacyNewClosedGroup(
        _ db: Database,
        ...
        let closedGroup: ClosedGroup = try ClosedGroup(
            ...
            isApproved: true    // Legacy closed groups should auto-approve
        ).saved(db)
    ...
    private static func handleLegacyClosedGroupEncryptionKeyPair(_ db: Database, message: LegacyClosedGroupControlMessage) throws {
        guard
    ...
    private static func handleLegacyClosedGroupNameChanged(_ db: Database, message: LegacyClosedGroupControlMessage) throws {
    ...
    private static func handleLegacyClosedGroupMembersAdded(_ db: Database, message: LegacyClosedGroupControlMessage) throws {
    ...
    private static func handleLegacyClosedGroupMembersRemoved(_ db: Database, message: LegacyClosedGroupControlMessage) throws {
    ...
    private static func handleLegacyClosedGroupMemberLeft(_ db: Database, message: LegacyClosedGroupControlMessage) throws {
