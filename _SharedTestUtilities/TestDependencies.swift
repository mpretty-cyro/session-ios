    ...
    public subscript<T: FeatureOption>(feature feature: FeatureConfig<T>) -> T? {
        ...
        set {
            ...
            if featureInstances[feature.identifier] == nil {
                _featureInstances.performUpdate { $0.setting(feature.identifier, feature.createInstance(self, key)) }
            }
            
            set(feature: feature, to: (newValue ?? feature.createInstance(self, key).defaultOption))
        }
    }
