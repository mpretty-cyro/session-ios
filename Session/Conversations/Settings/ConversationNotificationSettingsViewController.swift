        ...
        viewModel.items
            ...
            .sink { [weak self] items in
                ...
                items.enumerated().forEach { index, item in
                    ...
                    optionView.tapPublisher
                        .map { _ -> ConversationNotificationSettingsViewModel.Item.Id in item.id }
                        .sink(into: self?.viewModel.itemSelected)
                        .store(in: &optionView.disposables)
