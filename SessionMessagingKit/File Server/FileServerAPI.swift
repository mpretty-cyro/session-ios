...
public enum FileServerAPI {
    ...
    public static func upload(_ file: Data) -> AnyPublisher<FileUploadResponse, Error> {
        ...
        return send(request: request, serverPublicKey: serverPublicKey, timeout: FileServerAPI.fileUploadTimeout)
    ...
    public static func download(_ fileId: String, useOldServer: Bool) -> AnyPublisher<Data, Error> {
        ...
        return send(request: request, serverPublicKey: serverPublicKey, timeout: FileServerAPI.fileDownloadTimeout)
    }

    public static func getVersion(platform: String) -> AnyPublisher<String, Error> {
        let request = Request<NoBody, Endpoint>(
            server: server,
        ...
        return send(request: request, serverPublicKey: serverPublicKey, timeout: HTTP.defaultTimeout)
